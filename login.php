...
$result = mysqli_query("SELECT * FROM login WHERE username='$_POST[username]' AND password='$_POST[password]'");

if(mysqli_num_rows($result) == 1)
	{
		while($recarr = mysqli_fetch_array($conn,$result))
		{
			
		$_SESSION[username] = 	$recarr[username];
		$_SESSION[password] = 	$recarr[password];
